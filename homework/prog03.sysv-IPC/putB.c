/* **********************************************
  ...
  Created Time: Sun 13 Dec 2015 01:28:59 AM CST
...
print(struct shared_use_st* shared_stuff) {
	printf("put 1 product B.\n");
	printf("Current state: %d product A(s)\t%d product B(s)\treduce %d.\n", shared_stuff->high, shared_stuff->low, shared_stuff->high - shared_stuff->low);
}
